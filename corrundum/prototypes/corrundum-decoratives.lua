...
data:extend{
{
    ...
    pictures =
    {
        layers =
        {
            -- 2.1: huge-volcanic-rock sprites moved to vulcanus-rocks/vulcanus-rock-huge; load via util.sprite_load
            util.sprite_load("__space-age__/graphics/decorative/vulcanus-rocks/vulcanus-rock-huge", { scale = 0.5, variation_count = 15, multiply_shift = 0.5, tint = platinum_rock_tint })
        }
    }
}
}
